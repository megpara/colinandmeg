...
export default function Home() {
    return (
        <Layout>
            ...
            <video loop autoPlay muted playsInline className="absolute w-screen h-screen top-0 left-0 object-cover" src="/work/directorreel.mp4" poster="/work/bluemoon.png" />
